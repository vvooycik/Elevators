...
public class ElevatorManager {
    ...
    public void call(Elevator elevator, Integer floor) {
         ...
         */
            ...
            if (Math.abs(elevator.getCurrentFloor() - floor) <= Math.abs(otherElevator.getCurrentFloor() - floor)) {
                checkAllPossibilities(elevator, floor, false);
            }
            // the other one is closer
            else {
                checkAllPossibilities(otherElevator, floor, true);
            }
        }
    }

    private void makeAStop(Elevator elevator, Integer stop) {
    ...
    private void checkAllPossibilities(Elevator elevator, Integer floor, boolean isSecondary) {
        // is it free?
